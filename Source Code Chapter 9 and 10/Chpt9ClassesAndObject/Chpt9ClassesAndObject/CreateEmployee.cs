...
namespace Chpt9ClassesAndObject
{
    class CreateEmployee
    {
        static void Main()
        {
            Employee emp;
            //
            Employee myAsst = new Employee(); //instantiating a new object(instance) of Employee called myAsst
            myAsst.WelcomeMessage();


            //Passing object to a method as a parameter
            Employee aWorker = new Employee(); //first object
            Employee anotherWorker = new Employee(); //second object
